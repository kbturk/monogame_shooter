...
static class Input {
    ...
    public static void Update() {
        ...
        //if the player pressed one of the arrow keys or is using a gamepad
        // to aim, we want to disable mouse aiming. Otherwise, if the player
        // moves the mouse, enable mouse aiming.
